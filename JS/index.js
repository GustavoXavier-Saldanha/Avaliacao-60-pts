function ativarPrograma(){
    ...
    mensagens = mensagens + `<h3>O número do seu pedido é: ${numeroDoPedido()}</h3>`;
    mensagens = mensagens + `<p>Tamanho: ${tamanho}.</p><br>`;
    mensagens = mensagens + `<p>O tipo de borda escolhido é: ${borda}.</p><br>`;
    mensagens = mensagens + `<p>Uma metade será de: ${sabor}.</p><br>`;
    mensagens = mensagens + `<p>Sua bebida é: ${acompanhamento}.</p><br>`;
    ...
    mensagens = mensagens + `<h3>Informações do pedido:</h3><br>`;
    
    if(tipoEntrega == 2){
        mensagens = mensagens + `<p>O telefone para contato é: ${telefone}.</p><br>`;
        mensagens = mensagens + `<p>O endereço é: ${enderecoCompleto}.</p><br>`;
        mensagens = mensagens + `<p>O complemento é: ${complemento}.</p><br>`;
        mensagens = mensagens + `<p>O bairro é: ${bairro}.</p><br>`;
        mensagens = mensagens + `<p>A forma de pagamento será: ${pagamento}.</p><br>`;
        mensagens = mensagens + `<p>A referência informada é: ${referencia}.</p><br>`;
    }
    else{
        mensagens = mensagens + `<p>O nome de quem vai realizar a retirada é: ${nomeRetirada}.</p><br>`;
        mensagens = mensagens + `<p>O telefone de quem vai fazer a retirada é: ${telefoneRetirada}.</p><br>`; 
    }
    mensagens = mensagens + `<p>Muito obrigado pela preferencia, ${nome}.\nVolte sempre!!!</p><br>`; 
    }
    document.getElementById('detalhes').innerHTML = mensagens;
}
setTimeout(() => {
    ativarPrograma()
}, 1000);